...
export default function Home() {
  ...
  return (
    <>
      <h1>{userName}</h1>
      {/* <div
        className="relative container top-0 mb-20 border-dotted border-orange-500 border-y-2 min-w-full truncate 
        shadow-md shadow-gray-500/50 hover:border-purple-600 hover:border-y-4"
      ...
      >
        ...
        >
          ...
          <div className="hotbooks" style={{ width: "100%", height: "80vh" }}>
            <h1 className="font-bold text-2xl underline text-center tracking-widest">
              熱門書籍
            </h1>
            <BookFilter
              books={books}
      ...
      <div
        className="relative container top-0 mb-20 border-dotted border-orange-500 border-y-2 min-w-full truncate shadow-md shadow-gray-500/50 hover:border-purple-600 hover:border-y-4"
        style={{ top: "10vh", height: "80vh" }}
      >
        {/* import輪播圖 */}
        <div
          className="flex flex-col md:flex-row truncate"
      ...
      <div className="max-w-full h-[22vh] mb-2 font-semibold text-xl text-sky-700 truncate">
        <h3 className="fixed text-center pl-11 bg-white">
          簡介：品誠書店，您的閱讀天堂，提供各類書籍，滿足您的閱讀需求。
        </h3>
        <h3 className="fixed mt-7 pl-11 bg-white">
